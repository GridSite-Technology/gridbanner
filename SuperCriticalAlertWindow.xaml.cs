...
{
    public partial class SuperCriticalAlertWindow : Window, INotifyPropertyChanged
    {
        ...
        public Action? OnClosedLocally { get; set; }
        ...
        public SuperCriticalAlertWindow()
        {
            InitializeComponent();
            DataContext = this;
        }
        ...
        {
            Header = $"SUPER CRITICAL: {alert.Summary}";
